...
ok giờ updateheset lại file này cho tôinhes, tất cả những gì đã làm, quy trình từng bước 1 - kể cả bước nhỏ nhé, viết tiếng việt

Dưới đây là nội dung thay thế toàn bộ file docs/PROGRESS.md. Nội dung đã cập nhật lại đúng kiến trúc hiện tại: dùng Supabase, ảnh lưu trong GitHub, một JD gắn với nhiều group, bot tự điền nội dung, upload ảnh, tự đăng và chạy tuần tự toàn bộ danh sách.
